...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie() {
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=cec25250751dbdaa2fc0bd741a7609fe`);
    ...
    <main>
      <section className="flex justify-around  flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-700 dark:text-white">
          ...
          <p className="my-4">
          <span className="mr-2 font-bold">Realease:</span>
